...
export default function TransactionForm({
  ...
  const finalExternalReference =
    manualTransactionId?.trim() || ocrData?.external_reference || null;
                  ...
                  >
                    <View
                      style={{
                        ...
                        width: `${(activeLoan.amount_paid / activeLoan.total_payable) * 100}%`,
                      }}
                      className="h-full"
                    />
                  </View>
                ...
                ocrData && (
                  ...
                  >
                    <View className="flex-1 mr-4">
                      ...
                      {/* FIELD: Transaction ID (Web Manual Entry) */}
                      <View className="mt-4">
                        <Text
                          style={{ color: theme.gray700 }}
                        ...
                        <View
                          style={{
                            ...
                            borderColor: finalExternalReference
                              ? theme.emerald
                              : theme.gray200,
                          }}
